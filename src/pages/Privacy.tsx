...
const ULTIMA_ATUALIZACAO = "06/09/2026";
...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Em uma parte do site utilizamos também o{" "}
          <strong className="text-foreground">Pixel do OpenAI Ads</strong>, ferramenta da
          OpenAI, com a mesma finalidade: medir a eficácia das nossas campanhas
          publicitárias. Ele registra a visita e o evento "lead_created" quando você clica no
          botão para entrar no nosso grupo do WhatsApp, de forma agregada e sem identificar
          você pessoalmente.
        </p>
        <p className="mt-2">
          Cada página do site carrega no máximo um desses pixels, nunca os dois ao mesmo
          tempo: uma página medida pela OpenAI não envia nada à Meta, e vice-versa. Você pode
          consultar como a OpenAI trata dados pessoais na{" "}
          <a
